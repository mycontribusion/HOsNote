                ...
                <div className="flex items-start sm:items-center gap-4 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0 flex flex-col justify-center">
                        ...
                        <div className="flex items-center gap-1.5 mb-0.5 flex-wrap">
                            ...
                            {docCount > 0 && (
                                <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-lg text-[10px] font-bold bg-teal-50 dark:bg-teal-900/30 text-teal-600 dark:text-teal-400 whitespace-nowrap border border-teal-100 dark:border-teal-800/40">
                        ...
                        {(!name && !hospitalNumber) && (
                            <div className="text-sm font-medium text-gray-400 dark:text-gray-500 italic">No name provided</div>
                        )}
                        {/* Row 2: Diagnosis */}
                        {diagnosis && (
